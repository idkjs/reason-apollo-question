...
function renderItemNode(node) {
  ...
  if (match) {
    ...
    React.createElement("li", undefined, "No name");
  }
  var match$1 = node.id;
  if (match$1) {
    match$1[0] + "😭";
  } else {
    React.createElement("li", undefined, "No id");
  }
  var match$2 = node.age;
  if (match$2) {
              ...
              return ReasonReact.element(/* None */0, /* None */0, Curry.app(GetAllPersonsQuery[/* make */3], [
                              ...
                              (function (param) {
                                  ...
                                  if (typeof result === "number") {
                                    ...
                                    tmp = React.createElement("div", undefined, "TEST");
                                  } else {
...
exports.renderItemNode = renderItemNode;
